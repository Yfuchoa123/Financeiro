// lib/screens/reports/totais_por_projeto_report.dart

import 'package:flutter/material.dart';
import 'package:fl_chart/fl_chart.dart';
import 'package:meu_financeiro_pessoal/widgets/custom_app_bar.dart';

class TotaisPorProjetoReport extends StatelessWidget {
  const TotaisPorProjetoReport({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      // appBar: AppBar(
      //   title: const Text('Relatórios / Totais por projeto'),
      //   backgroundColor: const Color(0xFF00BFA5),
      //   foregroundColor: Colors.white,
      //   elevation: 0,
      // ),
      // ADICIONE ISTO NO LUGAR:
      appBar: const CustomAppBar(title: 'Relatórios / Totais por projeto'),
      body: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                            child: _buildCategoryList(
                                ...
                                items: {
                                  'Sem projeto': 'R\$ 9.910.212.653,96',
                                },
                                colors: [Colors.blue],
                                percentages: ['100,00%'],
