// lib/screens/reports/totais_por_centro_report.dart

import 'package:flutter/material.dart';
import 'package:fl_chart/fl_chart.dart';
import 'package:meu_financeiro_pessoal/widgets/custom_app_bar.dart';

class TotaisPorCentroReport extends StatelessWidget {
  const TotaisPorCentroReport({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      // appBar: AppBar(
      //   title: const Text('Relatórios / Totais por centro'),
      //   backgroundColor: const Color(0xFF00BFA5),
      //   foregroundColor: Colors.white,
      // ),
      // ADICIONE ISTO NO LUGAR:
      appBar: const CustomAppBar(title: 'Relatórios / Totais por centro'),
      body: Row(
  ...
  // Painel da Esquerda (Resumo) - Idêntico ao anterior
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        // Lista de Despesas - DADOS ATUALIZADOS
                        Expanded(
                            child: _buildCategoryList(
                                title: 'Total de despesas',
                                items: {
                                  'Sem centro': '-R\$ 12.314.755,99',
                                },
                                colors: [Colors.blue],
                                percentages: ['100,00%'],
                                total: '-R\$ 12.314.755,99')),
                        // Lista de Receitas - DADOS ATUALIZADOS
                        Expanded(
                            child: _buildCategoryList(
                                title: 'Total de receitas',
                                items: {
                                  'Sem centro': 'R\$ 9.910.212.653,96',
                                },
                                colors: [Colors.blue],
                                percentages: ['100,00%'],
          ...
          ListTile(
            ...
            trailing: Text(total,
                style: TextStyle(
                    ...
                    color: total.startsWith('-') ? Colors.red : Colors.green)),
            contentPadding: EdgeInsets.zero,
            dense: true,
          )
        ]
