// lib/screens/reports/totais_por_contato_report.dart

import 'package:flutter/material.dart';
import 'package:fl_chart/fl_chart.dart';
import 'package:meu_financeiro_pessoal/widgets/custom_app_bar.dart';

class TotaisPorContatoReport extends StatelessWidget {
  const TotaisPorContatoReport({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      // appBar: AppBar(
      //   // CORRIGIDO: AppBar simplificado para combinar com o design
      //   title: const Text('Relatórios / Totais por contato'),
      //   backgroundColor: const Color(0xFF00BFA5),
      //   foregroundColor: Colors.white,
      //   elevation: 0, // Remove a sombra para um look mais limpo
      // ),
      // ADICIONE ISTO NO LUGAR:
      appBar: const CustomAppBar(title: 'Relatórios / Totais por contato'),
      body: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                            child: _buildCategoryList(
                                ...
                                items: {
                                  'Sem contato': 'R\$ 9.910.212.653,96',
                                },
                                colors: [Colors.blue],
                                percentages: ['100,00%'],
